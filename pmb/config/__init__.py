...
necessary_kconfig_options_anbox = {
    ">=0.0.0": {  # all versions
        "all": {  # all arches
            ...
            "NETFILTER_XT_MATCH_QTAGUID": True,
            "NETFILTER_XT_MATCH_QUOTA2": True,
            ...
            "NETFILTER_XT_TARGET_IDLETIMER": True,
        ...
        "aarch64": {
            "ARMV8_DEPRECATED": True,
            "CP15_BARRIER_EMULATION": True,
            "SETEND_EMULATION": True,
            "SWP_EMULATION": True,
        },
    },
    "<4.6.0": {
